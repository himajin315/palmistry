  class BrainLine
    ...
    def result_think
      ...
      when 0 then
        result = @user.uname + " さんは論理的に考える左脳タイプの人です。<br>
      ...
      when 1 then
        result = @user.uname + " さんは感覚的に捉える右脳タイプの人です。<br>
        五感を使った仕事が向いています。<br>
      ...
      when 2 then
        result = @user.uname + " さんはなんでも平均的にできる人です。<br>
