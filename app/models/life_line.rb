class LifeLine
  ...
  def result_power(select_num)
    case select_num
    when '0' then
      result = @uname + " さんは生命力が強い人です。<br>
      徹夜してもピンピンしているような人でしょう。<br>
      体力の続く限り頑張ることができる人です<br>"
    when '1' then
      result = @uname + " さんは生命力は弱くはありません。<br>
      体力には問題はありませんが、たまに病気になってしまします。<br>
      年に一度風邪を引いたりします。<br>
      ストレスからくる病気にも注意が必要です。<br>"
    when '2' then
      result = @uname + "さんは病気にも注意が必要です。<br>
